...
public class User
{
    ...
    public User(final Integer stuid, final String studentid, final String password, final Integer schoolid, final Integer sex, final String name, final Date registertime, final Double money, final Integer state) {
        this.stuid = stuid;
